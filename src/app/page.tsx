        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-200 sm:text-5xl">
              Interact with your documents data in moments
            </h2>
            <p className="mt-4 text-lg text-gray-400">
              LivDoc uses the latest in NLP to make your document query
              experience seamless and thorough
            </p>
          </div>
        </div>
        {/* steps */}
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-400">
                LivDoc will prepare your document for chatting
              </span>
            </div>
          </li>
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="text-xl font-semibold">
                Begin asking questions through the chat interface
              </span>
              <span className="mt-2 text-zinc-400">
                That&apos;s it! Begin exploring your document with LivDoc.
              </span>
            </div>
          </li>
        </ol>
