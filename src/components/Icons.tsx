...
import logoBlob from "@/assets/logo-blob-png.png";
...
export const Icons = {
  ...
  logo: ({ ...props }: Omit<ImageProps, "src" | "alt">) => (
    <Image
      src={logoBlob}
      alt="LivDoc Logo"
      width={120} // Adjust dimensions as needed for a rectangular shape
      height={60}
      className="object-cover rounded-lg border border-zinc-100" // Style for a rectangular shape
